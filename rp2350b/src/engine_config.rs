//! Engine-specific configuration for RP2350B target
//! 4-cylinder, 2.0L, 440cc/min injectors @ 3 bar

use ecu_core::ve_engine::types::{AfrTable, InjectorConfig, VeTable};
...
pub fn baseline_ve() -> VeTable {
    VeTable::default_safe()
}
pub fn afr_table() -> AfrTable {
