...
pub fn combustion_phasing_result(
    config: CombustionConfig,
    spark_advance_deg10: CrankDeg10,
) -> CombustionPhasingResult {
    combustion_phasing_result_with_delay(config, 0, spark_advance_deg10)
}
...
pub fn evaluate_combustion<const CYL: usize>(
    ...
    evaluate_combustion_with_residual(
        config,
        timestamp_us,
        angle,
        cyl,
