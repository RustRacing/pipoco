...
macro_rules! capture_ring {
    ($name:ident, $n:expr) => {
        static $name: cortex_m::interrupt::Mutex<core::cell::RefCell<ecu_io::CaptureBuffer<$n>>> =
            cortex_m::interrupt::Mutex::new(core::cell::RefCell::new(ecu_io::CaptureBuffer::new()));
