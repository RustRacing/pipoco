...
fn snapshot_conversion_covers_non_default_diagnostics() {
    let runtime_snapshot = RuntimeSnapshot {
        ...
        calibration: ecu_runtime::CalibrationState::default(),
        scheduler: ecu_runtime::SchedulerState::new(),
        output_profile: ecu_runtime::RuntimeOutputProfile::default(),
        fuel_strategy_mode: ecu_runtime::RuntimeFuelStrategyMode::DirectPulseWidthTable,
