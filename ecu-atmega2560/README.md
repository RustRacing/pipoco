...
ECU runtime path. It targets the M50B25TU full sequential profile: six
injector channels and six coil-on-plug ignition channels.
...
can be built for an ATmega2560-class AVR target and can emit fixed-size logical
injector, ignition, auxiliary, and telemetry commands.
...
- output compare channels for six injectors and six coil-on-plug ignition
  outputs,
- auxiliary pins for VANOS, idle valve, fuel pump, fan, tach, CEL, boost, and
  spare outputs,
