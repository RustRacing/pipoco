...
pub struct DfcoConfig {
    pub tps_max_pct: u8,     // below this TPS allows DFCO
    pub map_max_kpa: u16,    // below this MAP allows DFCO
    pub rpm_min: u16,        // above this RPM allows DFCO
    pub rpm_max: u16,        // optional upper bound
    pub delay_ms: u32,       // delay before engaging
    pub resume_hyst_ms: u32, // minimum time before resume allowed
}
