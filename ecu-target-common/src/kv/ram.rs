...
pub const PERSIST_KEY_FUEL: &[u8] = ecu_core::persist::PERSIST_KEY_FUEL;
pub const PERSIST_KEY_IGN: &[u8] = ecu_core::persist::PERSIST_KEY_IGN;
pub const PERSIST_KEY_ANGLES: &[u8] = ecu_core::persist::PERSIST_KEY_ANGLES;
pub const PERSIST_KEY_EXPERT_TRIGGER: &[u8] = ecu_core::persist::PERSIST_KEY_EXPERT_TRIGGER;
...
mod tests {
    use super::*;
    use ecu_core::persist::PERSIST_KNOWN_KEYS as CORE_PERSIST_KNOWN_KEYS;

    #[test]
    fn shared_persistence_keys_match_core() {
        assert_eq!(PERSIST_KNOWN_KEYS, CORE_PERSIST_KNOWN_KEYS);
    }
