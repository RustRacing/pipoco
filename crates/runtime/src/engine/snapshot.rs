...
impl EngineRuntime {
    ...
    pub(super) fn refresh_snapshot(&mut self) {
        self.runtime_snapshot = RuntimeSnapshot {
            ...
            fuel_strategy_mode: crate::observations::runtime_fuel_strategy_mode(
                self.fuel_strategy(),
            ),
            ...
            direct_fuel_cut_request: self.direct_fuel_cut_request,
            direct_spark_cut_request: self.direct_spark_cut_request,
