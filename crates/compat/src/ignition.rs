...
use crate::interp::{bilinear_interpolate_i16, find_bin_interpolation};
...
impl IgnitionTable {
    ...
    /// Lookup ignition timing using bilinear interpolation.
    ///
    /// # Arguments
...
impl TableLookup for IgnitionTable {
    fn lookup(&self, rpm: u16, load: u16) -> u16 {
        self.lookup_bilinear(rpm, load) as u16
    }
}
