...
pub fn encode_angles_page(page: &AnglesPage, out: &mut [u8]) -> Result<usize, PageCodecError> {
...
pub fn decode_angles_page(data: &[u8]) -> Result<AnglesPage, PageCodecError> {
...
pub fn encode_sensors_page(page: &SensorsPage, out: &mut [u8]) -> Result<usize, PageCodecError> {
...
pub fn decode_sensors_page(data: &[u8]) -> Result<SensorsPage, PageCodecError> {
    // Layout (LE):
...
pub fn encode_limits_page(page: &LimitsPage, out: &mut [u8]) -> Result<usize, PageCodecError> {
...
pub fn decode_limits_page(data: &[u8]) -> Result<LimitsPage, PageCodecError> {
