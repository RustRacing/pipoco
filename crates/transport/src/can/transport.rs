//! CAN transport: framing/reassembly/sequence/routes/health plus device
//! profiles and the `CanDevice`/`CanTransport` adapters (split from the can
//! monolith; review 006).
